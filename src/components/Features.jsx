...
function Features(props) {
  return (
    <section className="h-auto lg:h-screen flex justify-center items-center flex-col text-center max-w-screen-xl m-auto features mt-20">
      <h2 className="text-center text-xl lg:text-6xl mb-16 lg:mb-28 font-bold">
      ...
      <div className="flex basis-0 flex-wrap lg:flex-nowrap lg:gap-10 gap-16 max-w-full md:max-w-[50%] lg:max-w-full">
        ...
        >
          ...
          <p className="text-xs lg:text-base font-mediu">
