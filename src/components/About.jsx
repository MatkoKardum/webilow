...
function About() {
  return (
    <section
      className="h-[100vh] flex justify-center items-center flex-col max-w-screen-xl m-auto about"
      id="about"
    >
      <h1 className="mb-24 text-6xl font-bold">Learn about us</h1>
      <div className="flex justify-center mt-5">
        <div className="max-w-[50%]">
          <h2 className="text-4xl font-bold mb-6">Overview</h2>
          <p className="mb-10 font-normal text-lg text-gray-300">
        ...
        <div className="flex items-center flex-col max-w-[50%] ml-16">
          ...
          <p className="font-normal text-lg mb-5 text-gray-300">
