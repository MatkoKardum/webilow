function Contact() {
  return (
    <section className="h-[80vh] max-w-screen-xl m-auto ">
      <form className="bg-[#1f2937] p-20 rounded-lg">
        ...
        <button
          type="submit"
          className="w-full bg-blue-600 rounded-md mt-8 py-2 text-xl  hover:bg-blue-800 hover:border-blue-800 transition duration-200 active:bg-blue-600 active:border-blue-600 contact"
        >
          Submit
        </button>
      </form>
